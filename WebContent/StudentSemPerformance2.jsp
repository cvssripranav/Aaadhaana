...
<a href=<%= "\"StdentDetails2.jsp?rno=" + request.getParameter("rno") + "&department="+request.getParameter("department")+"\"" %> id="studentdetails">CompleteDetails</a>
...
<%-- <a href=<%= "\"StdentDetails2.jsp?rno=" + "WEEKS" + "\"" %> id="logout">CompleteDetails</a> --%>
<table align="center" cellpadding="4" cellspacing="4" id="studentsemester">
<tr>
